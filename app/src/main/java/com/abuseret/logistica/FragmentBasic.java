...
import com.abuseret.logistica.modelos.Perfil;
import com.abuseret.logistica.modelos.PrductosxOrden;
import com.abuseret.logistica.modelos.Producto;
import com.abuseret.logistica.modelos.ReporteClienteProducto;
import com.abuseret.logistica.modelos.Usuario;
import com.abuseret.logistica.util.Constantes;
import com.abuseret.logistica.util.Imagenes;
...
import static com.abuseret.logistica.util.Constantes.ESQUEMA_FAVORITOS;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_ORDENES;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_ORDENES_CABECERA;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_ORDENES_DETALLE;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_ORDENES_TOTAL_INICIAL;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_PAGOS;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_PERFIL_DE_PRECIOS;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_PICKING;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_PICKING_TOTAL;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_PRODUCTOS_EN_ORDENES_INICIAL;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_REPORTE_VENTAS_CLIENTE;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_REPORTE_VENTAS_PRODUCTO;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_SALDOS_HISTORIAL;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_SALDO_TOTAL;
import static com.abuseret.logistica.util.Constantes.ESQUEMA_STOCK;
...
import static com.abuseret.logistica.util.Constantes.EXTRA_EMPRESA;
import static com.abuseret.logistica.util.Constantes.EXTRA_EMPRESA_KEY;
import static com.abuseret.logistica.util.Constantes.EXTRA_FIREBASE_URL;
import static com.abuseret.logistica.util.Constantes.EXTRA_PERFIL;
...
import static com.abuseret.logistica.util.Constantes.EXTRA_USER_KEY;
import static com.abuseret.logistica.util.Constantes.NODO_ALMACENES;
import static com.abuseret.logistica.util.Constantes.NODO_FAVORITOS;
import static com.abuseret.logistica.util.Constantes.NODO_ORDENES;
import static com.abuseret.logistica.util.Constantes.NODO_ORDENES_CABECERA;
import static com.abuseret.logistica.util.Constantes.NODO_ORDENES_DETALLE;
import static com.abuseret.logistica.util.Constantes.NODO_ORDENES_TOTAL_INICIAL;
import static com.abuseret.logistica.util.Constantes.NODO_PAGOS;
import static com.abuseret.logistica.util.Constantes.NODO_PAGOS_PICKING;
import static com.abuseret.logistica.util.Constantes.NODO_PICKING;
import static com.abuseret.logistica.util.Constantes.NODO_PICKING_TOTAL;
import static com.abuseret.logistica.util.Constantes.NODO_PRODUCTOS_EN_ORDENES_INICIAL;
import static com.abuseret.logistica.util.Constantes.NODO_REPORTE_VENTAS_CLIENTE;
import static com.abuseret.logistica.util.Constantes.NODO_REPORTE_VENTAS_PRODUCTO;
import static com.abuseret.logistica.util.Constantes.NODO_SALDOS_HISTORIAL;
import static com.abuseret.logistica.util.Constantes.NODO_SALDO_TOTAL;
import static com.abuseret.logistica.util.Constantes.NODO_STOCK;
import static com.abuseret.logistica.util.Constantes.ORDEN_STATUS_DELIVERED_PARA_COMPENSAR;
...
import static com.abuseret.logistica.util.UtilFirebase.getDatabase;
